...
AddEventHandler('esx_kr_shops:setToSell', function(id, Item, ItemCount, Price) --draco
  local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_kr_shop:getAllShipments', function(source, cb, id) --draco
  local identifier = ESX.GetPlayerFromId(source).identifier
...
ESX.RegisterServerCallback('esx_kr_shop:getOwnedShop', function(source, cb, id) --draco
local src = source
local identifier = ESX.GetPlayerFromId(src).identifier
...
AddEventHandler('esx_kr_shops:addMoney', function(amount, number) ---draco
local _source = source
local xPlayer = ESX.GetPlayerFromId(_source)
local identifier = ESX.GetPlayerFromId(source).identifier
    ...
    MySQL.Async.fetchAll(
        ...
        TriggerClientEvent('esx:showNotification', xPlayer.source, '~r~You can\'t put in more than you own') --draco
        end
    end)
end)

RegisterServerEvent('esx_kr_shops:takeOutMoney')
AddEventHandler('esx_kr_shops:takeOutMoney', function(amount, number) --draco
local src = source
local identifier = ESX.GetPlayerFromId(src).identifier
local xPlayer = ESX.GetPlayerFromId(src)
